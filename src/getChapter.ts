...
export const getChapter = async (c: Context, testament: Testament): Promise<Response> => {
  ...
  const testamentFolder = testament === "Nuevo Testamento" ? "newTestament" : "oldTestament"
